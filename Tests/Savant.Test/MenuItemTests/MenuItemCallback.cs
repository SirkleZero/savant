...
namespace Savant.Test.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new SavantPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(Savant.GuidList.guidSavantPackageCmdSet, (int)Savant.PkgCmdIDList.generateDataAdaptersCommand);
